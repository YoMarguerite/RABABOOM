...
public class cpuSideCode : MonoBehaviour {
    ...
    void Update(){
        ...
        //if(inputChange) {			
        //          areaRectArray[0] = -depth;
        //          areaRectArray[1] = -depth;
        //          areaRectArray[2] = depth;
        //          areaRectArray[3] = depth;
        //          areaRectBuffer.SetData(areaRectArray);
        //          calcFractal();
        //	depth -= 0.01;
        //	print(depth);
	...
	void input(){					// in this method we simply change size and position of the view rect in fractal dimension, but it is always projected to the texture
		...
		if (inputChange){
			...
			print("0:" + areaRectArray[0]);
            print("1:" + areaRectArray[1]);
            print("2:" + areaRectArray[2]);
            print("3:" + areaRectArray[3]);
